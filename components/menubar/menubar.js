...
var MenubarSub = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], MenubarSub.prototype, "item");
    __decorate([
        core_1.Input()
    ], MenubarSub.prototype, "root");
    __decorate([
        core_1.Input()
    ], MenubarSub.prototype, "autoDisplay");
    __decorate([
        core_1.Input()
    ], MenubarSub.prototype, "autoZIndex");
    __decorate([
        core_1.Input()
    ], MenubarSub.prototype, "baseZIndex");
...
var Menubar = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], Menubar.prototype, "model");
    __decorate([
        core_1.Input()
    ], Menubar.prototype, "style");
    __decorate([
        core_1.Input()
    ], Menubar.prototype, "styleClass");
    __decorate([
        core_1.Input()
    ], Menubar.prototype, "autoDisplay");
    __decorate([
        core_1.Input()
    ], Menubar.prototype, "autoZIndex");
    __decorate([
        core_1.Input()
    ], Menubar.prototype, "baseZIndex");
    Menubar = __decorate([
        core_1.Component({
            selector: 'p-menubar',
