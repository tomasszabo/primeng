...
var MegaMenu = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], MegaMenu.prototype, "model");
    __decorate([
        core_1.Input()
    ], MegaMenu.prototype, "style");
    __decorate([
        core_1.Input()
    ], MegaMenu.prototype, "styleClass");
    __decorate([
        core_1.Input()
    ], MegaMenu.prototype, "orientation");
    __decorate([
        core_1.Input()
    ], MegaMenu.prototype, "autoZIndex");
    __decorate([
        core_1.Input()
    ], MegaMenu.prototype, "baseZIndex");
    MegaMenu = __decorate([
        core_1.Component({
            selector: 'p-megaMenu',
